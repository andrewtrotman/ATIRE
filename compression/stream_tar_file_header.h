/*
	STREAM_TAR_FILE_HEADER.H
	------------------------
*/
#ifndef STREAM_TAR_FILE_HEADER_H_
#define STREAM_TAR_FILE_HEADER_H_
...
*/
class ANT_stream_tar_file_header
{
public:
	/*
...
#endif /* STREAM_TAR_FILE_HEADER_H_ */
