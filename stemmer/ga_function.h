...
private:
    ...
    double (*function) (ANT_search_engine *, char *, long *, 
                        ANT_stemmer *, long, double, ANT_mean_average_precision *);
public:
    GA_stemmer *stemmer;
    double call();
    GA_function(double (*)(ANT_search_engine *, char *, long *, ANT_stemmer *, long, double, ANT_mean_average_precision *),
                ANT_search_engine *, long, char **, long *, double *, ANT_mean_average_precision *);
