...
typedef double (*ga_func_t)(ANT_ANT_param_block *,ANT_search_engine *, char *, long long *, 
...
public:
    GA_stemmer *stemmer;
    double call();
    GA_function(ga_func_t, ANT_ANT_param_block *, ANT_search_engine *, long, char **, long *,
