...
EXTRA_INCLUDE = $(EXTRA_INCLUDE) -I external\gpl\lzo\lzo-2.10\include\lzo -I external\gpl\lzo\lzo-2.10\include
...
MINUS_D = $(EXTRA_MINUS_D) -DHASHER=1 -DLOOKUP3=1 
...
PARTS = \
	...
	$(OBJDIR)\instream_Z.obj						\
	$(OBJDIR)\instream_tgz.obj						\
