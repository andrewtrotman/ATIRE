...
public:
	...
	static int iseuropean(const unsigned char *here);
	static int iseuropean(const char *here) { return iseuropean((const unsigned char *)here); }
...
*/
inline int UNISEG_encoding_utf8::iseuropean(const unsigned char *here)
{
