...
extern "C" {
#endif
extern int german2_ISO_8859_1_stem(struct SN_env * z);
#ifdef __cplusplus
}
#endif
...
extern struct SN_env * german2_ISO_8859_1_create_env(void);
extern void german2_ISO_8859_1_close_env(struct SN_env * z);
...
static const symbol s_5[] = { 0xE4 };
static const symbol s_6[] = { 0xF6 };
static const symbol s_7[] = { 0xFC };
    ...
    while(1) { /* repeat, line 40 */
        ...
        switch(among_var) {
            ...
            case 2:
                ...
                break;
            case 3:
                {   int ret = slice_from_s(z, 1, s_6); /* <-, line 44 */
                    if (ret < 0) return ret;
                }
                break;
            case 4:
...
extern struct SN_env * german2_ISO_8859_1_create_env(void) { return SN_create_env(0, 3, 0); }

extern void german2_ISO_8859_1_close_env(struct SN_env * z) { SN_close_env(z, 0); }
