...
extern "C" {
#endif
extern int kraaij_pohlmann_ISO_8859_1_stem(struct SN_env * z);
#ifdef __cplusplus
}
#endif
...
extern struct SN_env * kraaij_pohlmann_ISO_8859_1_create_env(void);
extern void kraaij_pohlmann_ISO_8859_1_close_env(struct SN_env * z);
...
static int r_lengthen_V(struct SN_env * z) {
    {   int m1 = z->l - z->c; (void)m1; /* do, line 39 */
        if (out_grouping_b(z, g_v_WX, 97, 121, 0)) goto lab0;
        z->ket = z->c; /* [, line 40 */
        {   int m2 = z->l - z->c; (void)m2; /* or, line 40 */
            if (in_grouping_b(z, g_AOU, 97, 117, 0)) goto lab2;
            z->bra = z->c; /* ], line 40 */
            {   int m_test = z->l - z->c; /* test, line 40 */
                {   int m3 = z->l - z->c; (void)m3; /* or, line 40 */
                    if (out_grouping_b(z, g_v, 97, 121, 0)) goto lab4;
                    goto lab3;
                lab4:
                    z->c = z->l - m3;
        ...
        lab2:
            ...
            {   int m_test = z->l - z->c; /* test, line 41 */
                {   int m4 = z->l - z->c; (void)m4; /* or, line 41 */
                    if (out_grouping_b(z, g_v, 97, 121, 0)) goto lab6;
                    goto lab5;
                lab6:
                    z->c = z->l - m4;
            ...
            lab5:
                {   int m5 = z->l - z->c; (void)m5; /* not, line 42 */
                    if (in_grouping_b(z, g_AIOU, 97, 117, 0)) goto lab7;
                    goto lab0;
                lab7:
                    z->c = z->l - m5;
                }
                {   int m6 = z->l - z->c; (void)m6; /* not, line 43 */
                    ...
                    z->c--; /* next, line 43 */
                    if (in_grouping_b(z, g_AIOU, 97, 117, 0)) goto lab8;
                    if (out_grouping_b(z, g_v, 97, 121, 0)) goto lab8;
                    goto lab0;
                lab8:
                    z->c = z->l - m6;
                }
...
static int r_Lose_prefix(struct SN_env * z) {
    ...
    if (out_grouping(z, g_v, 97, 121, 1) < 0) return 0; /* goto */ /* grouping v, line 190 */
    if (in_grouping(z, g_v, 97, 121, 1) < 0) return 0; /* goto */ /* non v, line 190 */
...
static int r_Lose_infix(struct SN_env * z) {
    ...
    if (out_grouping(z, g_v, 97, 121, 1) < 0) return 0; /* goto */ /* grouping v, line 197 */
    if (in_grouping(z, g_v, 97, 121, 1) < 0) return 0; /* goto */ /* non v, line 197 */
...
static int r_measure(struct SN_env * z) {
    ...
    {   int c2 = z->c; /* do, line 208 */
        while(1) { /* repeat, line 209 */
            if (out_grouping(z, g_v, 97, 121, 0)) goto lab2;
            continue;
        lab2:
            break;
        }
        ...
        if (out_grouping(z, g_v, 97, 121, 0)) goto lab1;
        z->I[1] = z->c; /* setmark p1, line 209 */
        while(1) { /* repeat, line 210 */
            if (out_grouping(z, g_v, 97, 121, 0)) goto lab6;
            continue;
        lab6:
            break;
        }
...
extern struct SN_env * kraaij_pohlmann_ISO_8859_1_create_env(void) { return SN_create_env(1, 3, 3); }

extern void kraaij_pohlmann_ISO_8859_1_close_env(struct SN_env * z) { SN_close_env(z, 1); }
