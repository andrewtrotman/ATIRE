...
public:
	...
	char *doc_tag;                      // the tag for deciding the beginning and the end of document
	char *docno_tag; 					// the tag for deciding the beginning and the end of document id
	...
	long stop_word_df_frequencies;   	// remove words based on the document frequencies
