...
protected:
	...
	static const long long search_functions = BM25 | IMPACT | READABLE | LMD | LMJM | LMDS | BOSE_EINSTEIN | DIVERGENCE | TERM_COUNT | ALL_TERMS | INNER_PRODUCT | KBTFIDF | DLH13 | DOCID | PREGEN | DPH | DFREE | DFI | DFIW | DFI_IDF | DFIW_IDF | PUURULA;
...
public:
	...
	double puurula_u, puurula_g;		// the g (discounting factor) and u for Purella's language model.
	...
	double feedback_puurula_u, feedback_puurula_g;	// the g (discounting factor) and u for Purella's language model.
