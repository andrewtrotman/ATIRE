...
{
private:
	long maximum_judgement; // the maximum grade a judgement can have, TREC's gdeval sets this to 4, so we use that as a default
...
public:
	...
	void set_maximum_judgement(long maximum_judgement) { this->maximum_judgement = maximum_judgement; }
