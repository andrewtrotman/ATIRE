...
/*
	ANT_STEMMER_PORTER::LENGTH()
	----------------------------
*/
long ANT_stemmer_porter::length(char *reversed)
{
char *end, was;
long size;
...
/*
	ANT_STEMMER_PORTER::HAS_VOWEL()
	-------------------------------
*/
long ANT_stemmer_porter::has_vowel(char *what)
{
char *pos;
...
*/
long ANT_stemmer_porter::stem(char *what, char *destination)
{
