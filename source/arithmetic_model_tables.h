...
extern const unsigned int ANT_symbol_frequencies_base37[];
extern const unsigned int ANT_symbol_frequencies_ascii_printables[];
extern const unsigned int ANT_symbol_frequencies_base32[];
