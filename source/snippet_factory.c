...
/*
	...
	----------------------------------------
*/
ANT_snippet *ANT_snippet_factory::get_snippet_maker(long type, long length_of_snippet, long length_of_longest_document, char *tag, ANT_search_engine *engine, ANT_stem *stemmer)
{
