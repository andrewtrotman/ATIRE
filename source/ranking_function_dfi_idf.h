/*
	RANKING_FUNCTION_DFI_IDF.H
	--------------------------
*/
#ifndef RANKING_FUNCTION_DFI_IDF_H_
#define RANKING_FUNCTION_DFI_IDF_H_

#include "ranking_function.h"

/*
	class ANT_RANKING_FUNCTION_DFI_IDF
	----------------------------------
*/
class ANT_ranking_function_DFI_IDF : public ANT_ranking_function
{
public:
	ANT_ranking_function_DFI_IDF(ANT_search_engine *engine, long quantize, long long quantization_bits) : ANT_ranking_function(engine, quantize, quantization_bits) {}
	ANT_ranking_function_DFI_IDF(long long documents, ANT_compressable_integer *document_lengths, long long quantization_bits) : ANT_ranking_function(documents, document_lengths, quantization_bits) {}
	virtual ~ANT_ranking_function_DFI_IDF() {}
#ifdef IMPACT_HEADER
...
#endif /* RANKING_FUNCTION_DFI_IDF_H_ */
