...
/*
	...
	------------------------------------------
*/
class ANT_ranking_function_topsig_positive : public ANT_ranking_function
{
public:
	ANT_ranking_function_topsig_positive(ANT_search_engine *engine) : ANT_ranking_function(engine) {}
	ANT_ranking_function_topsig_positive(long long documents, ANT_compressable_integer *document_lengths) : ANT_ranking_function(documents, document_lengths) {}
