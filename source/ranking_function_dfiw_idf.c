...
/*
	...
	-------------------------------------
*/
double ANT_ranking_function_DFIW_IDF::rank(ANT_compressable_integer docid, ANT_compressable_integer length, unsigned char term_frequency, long long collection_frequency, long long document_frequency)
{
