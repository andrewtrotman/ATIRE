/*
	RANKING_FUNCTION_DFREE.H
	------------------------
*/
#ifndef RANKING_FUNCTION_DFREE_H_
#define RANKING_FUNCTION_DFREE_H_

#include "ranking_function.h"

/*
	class ANT_RANKING_FUNCTION_DFRee
	--------------------------------
*/
class ANT_ranking_function_DFRee : public ANT_ranking_function
{
public:
	ANT_ranking_function_DFRee(ANT_search_engine *engine) : ANT_ranking_function(engine) {}
...
#endif /* RANKING_FUNCTION_DFREE_H_ */
