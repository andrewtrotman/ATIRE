...
{
{ANT_ranking_function_factory_object::BM25,          "BM25",      "<k1>:<b>",ANT_ranking_function_factory_object::INDEXABLE, 2, ANT_RANKING_FUNCTION_BM25_DEFAULT_K1, ANT_RANKING_FUNCTION_BM25_DEFAULT_B, ANT_RANKING_FUNCTION_BM25_DEFAULT_K1, ANT_RANKING_FUNCTION_BM25_DEFAULT_B, "BM25 with k1=<k1> and b=<b> [default k1=0.9 b=0.4, use 1.1:0.3 for INEX 2009"}, 
...
{ANT_ranking_function_factory_object::DLH13,         "DLH13",      NULL,     ANT_ranking_function_factory_object::INDEXABLE, 0, 0, 0, 0, 0, "Terrier DLH13 (Terrier's function, not the published DLH13)"}, 
{ANT_ranking_function_factory_object::DPH,           "DPH",        NULL,     ANT_ranking_function_factory_object::INDEXABLE, 0, 0, 0, 0, 0, "Terrier DPH"}, 
{ANT_ranking_function_factory_object::DFREE,         "DFRee",      NULL,     ANT_ranking_function_factory_object::INDEXABLE, 0, 0, 0, 0, 0, "Terrier DFRee"}, 
{ANT_ranking_function_factory_object::DFI,           "DFI",        NULL,     ANT_ranking_function_factory_object::INDEXABLE, 0, 0, 0, 0, 0, "Divergence From Independence (TREC 2010 function)"}, 
{ANT_ranking_function_factory_object::DFIW,          "DFIW",       NULL,     ANT_ranking_function_factory_object::INDEXABLE, 0, 0, 0, 0, 0, "Divergence From Independence Web (TREC 2011 function)"}, 
{ANT_ranking_function_factory_object::DFI_IDF,       "DFI_IDF",    NULL,     ANT_ranking_function_factory_object::INDEXABLE, 0, 0, 0, 0, 0, "Divergence From Independence with IDF)"}, 
{ANT_ranking_function_factory_object::DFIW_IDF,      "DFIW_IDF",   NULL,     ANT_ranking_function_factory_object::INDEXABLE, 0, 0, 0, 0, 0, "Divergence From Independence Web with IDF"}, 
{ANT_ranking_function_factory_object::INNER_PRODUCT, "tfidf",      NULL,     ANT_ranking_function_factory_object::INDEXABLE, 0, 0, 0, 0, 0, "TF.IDF (vector space inner product)"}, 
{ANT_ranking_function_factory_object::KBTFIDF,       "kbtfidf",   "<k>:<b>", ANT_ranking_function_factory_object::INDEXABLE, 2, ANT_RANKING_FUNCTION_KBTFIDF_DEFAULT_K, ANT_RANKING_FUNCTION_KBTFIDF_DEFAULT_B, ANT_RANKING_FUNCTION_KBTFIDF_DEFAULT_K, ANT_RANKING_FUNCTION_KBTFIDF_DEFAULT_B, "log(k * tf - b) * idf * idf (Shlomo's vector space)"},
...
{ANT_ranking_function_factory_object::PREGEN,        "pregen:<name>[:a]",    NULL,      ANT_ranking_function_factory_object::NONINDEXABLE | ANT_ranking_function_factory_object::QUANTABLE, 0, 0, 0, 0, 0, "Pregenerated ranking, with field of given name, optionally ascending"},
...
/*
	...
	---------------------------------------------------
*/
ANT_ranking_function *ANT_ranking_function_factory::get_indexing_ranker(long long ranking_function, long long documents, ANT_compressable_integer *lengths, long long quantization_bits, double p1, double p2)
{
...
/*
	...
	----------------------------------------------------
*/
ANT_ranking_function *ANT_ranking_function_factory::get_searching_ranker(ANT_search_engine *search_engine, long long function, long quantization, long long quantization_bits, double p1, double p2)
{
