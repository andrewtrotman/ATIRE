...
{ANT_ranking_function_factory_object::TFLODOP,       "TFlodop",   "<b>:<d>",      ANT_ranking_function_factory_object::NONINDEXABLE, 1, ANT_RANKING_FUNCTION_TFLODOP_DEFAULT_B, ANT_RANKING_FUNCTION_TFLODOP_DEFAULT_DELTA, 0, ANT_RANKING_FUNCTION_TFLODOP_DEFAULT_B, ANT_RANKING_FUNCTION_TFLODOP_DEFAULT_DELTA, 0, "TFlodop*IDF (Rousseau & Vazirgiannis) with b=<b> and delta=<d> [default b=0.1, d=0.1]"},
