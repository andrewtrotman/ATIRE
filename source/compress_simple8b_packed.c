...
/*
	ANT_COMPRESS_SIMPLE8B_PACKED::INTS_PACKED_TABLE[]
	--------------------------------------------
...
/*
	ANT_COMPRESS_SIMPLE8B_PACKED::CAN_PACK()
	---------------------------------
...
/*
	ANT_COMPRESS_SIMPLE8B_PACKED:PACK()
	----------------------------
...
/*
	ANT_COMPRESS_SIMPLE8B_PACKED::COMPRESS()
	--------------------------------
*/
long long ANT_compress_simple8b_packed::compress(unsigned char *destination, long long destination_length, ANT_compressable_integer *source, long long source_integers)
{
long long words_in_compressed_string, pos;
long num_to_pack;
uint32_t mask_type;
uint64_t *into = (uint64_t *)destination;
uint64_t *end = (uint64_t *)(destination + destination_length);
...
/*
	ANT_COMPRESS_SIMPLE8B_PACKED::DECOMPRESS()
	----------------------------------
*/
void ANT_compress_simple8b_packed::decompress(ANT_compressable_integer *destination, unsigned char *source, long long destination_integers)
{
