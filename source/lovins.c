/*
	...
	I've removed the crap, put it into a C++ class and so on. 
*/
...
#include <stdlib.h>
#include <string.h>
#define bcopy(source, destination, n) memmove(destination, source, n)
...
*
****************************************************************************/
int aio (char ch) { return ((ch != 'a') && (ch != 'i') && (ch != 'o')); } /* Rule number 9     */
int s (char ch) { return (ch != 's'); } /* Rule Number 24    */
int pt (char ch) { return ((ch != 'p') && (ch != 't')); } /* Rule number 28    */
int m (char ch) { return (ch != 'm'); } /* Rule number 30    */
int n (char ch) { return (ch != 'n'); } /* Rule number 32    */
...
*
*************************************************************************/
int B(int stem_length, char *end) { return (stem_length >= 3); }
int C(int stem_length, char *end) { return (stem_length >= 4); }
int D(int stem_length, char *end) { return (stem_length >= 5); }
int E(int stem_length, char *end) { return (*end != 'e'); }
int F(int stem_length, char *end) { return ((stem_length >= 3) && (*end != 'e')); }
int G(int stem_length, char *end) { return ((stem_length >= 3) && (*end == 'f')); }
int H(int stem_length, char *end) { return ((*end == 't') || ((*end == 'l') && (*(end - 1) == 'l'))); }
int I(int stem_length, char *end) { return ((*end != 'o') && (*end != 'e')); }
int J(int stem_length, char *end) { return ((*end != 'a') && (*end != 'e')); }
int K(int stem_length, char *end) { return ((stem_length >= 3) && ((*end == 'l') || (*end == 'i') || ((*end == 'e') && (*(end - 2) == 'u')))); }
int L(int stem_length, char *end) { return (*end == 's') ? (*(end - 1) == 'o') : ((*end != 'u') && (*end != 'x')); }
int M(int stem_length, char *end) { return ((*end != 'a') && (*end != 'c') && (*end != 'e') && (*end != 'm')); }
int N(int stem_length, char *end) { return (stem_length >= 3) ? (*(end - 2) == 's') ? (stem_length >= 4) : 1 : 0; }
int O(int stem_length, char *end) { return ((*end == 'l') || (*end == 'i')); }
int P(int stem_length, char *end) { return (*end != 'c'); }
int Q(int stem_length, char *end) { return ((stem_length >= 3) && (*end != 'l') && (*end != 'n')); }
int R(int stem_length, char *end) { return ((*end == 'n') || (*end == 'r')); }
int S(int stem_length, char *end) { return (*end == 't') ? (*(end - 1) != 't') : ((*end == 'r') && (*(end - 1) == 'd')); }
int T(int stem_length, char *end) { return (*end == 't') ? (*(end - 1) != 'o') : (*end == 's'); }
int U(int stem_length, char *end) { return ((*end == 'l') || (*end == 'm') || (*end == 'n') || (*end == 'r')); }
int V(int stem_length, char *end) { return (*end == 'c'); }
int W(int stem_length, char *end) { return ((*end != 's') && (*end != 'u')); }
int X(int stem_length, char *end) { return (*end == 'e') ? ((stem_length >= 3) && (*(end - 2) == 'u')) : ((*end == 'l') || (*end == 'i')); }
int Y(int stem_length, char *end) { return ((*end == 'n') && (*(end - 1) == 'i')); }
int Z(int stem_length, char *end) { return (*end != 'f'); }

int AA(int stem_length, char *end)
	{
	char p1, p2;
	p1 = *end;
	p2 = *(end - 1);
...
int BB (int stem_length, char *end) { return ((stem_length > 2) && (strncmp (end - 2, "met", 3) != 0) && ((stem_length < 4) || (strncmp (end - 3, "ryst", 4) != 0))) ? 1 : 0; } /* CHANGED by EF */ 
int CC (int stem_length, char *end) { return (*end == 'l'); }
...
void stem (unsigned char * word)
{
  ...
  /* [RPAP - Jan 97: Stem Index Change] */
  unsigned char copy[MAX_STEM_LENGTH + 2];
  bcopy ((char *) word, (char *) copy, *word + 1);
  ...
  *copy = new_length;  /* [RPAP - Jan 97: Stem Index Change] */
  ...
  /* [RPAP - Jan 97: Stem Index Change] */
  bcopy ((char *) copy, (char *) word, *copy + 1);
...
void recode_stem(char *stem_end)
{
